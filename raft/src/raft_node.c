...
raft_index_t raft_node_get_next_send_idx(raft_node_t* me_)
{
    raft_node_private_t* me = (raft_node_private_t*)me_;
    return me->next_send_idx;
}

void raft_node_set_next_send_idx(raft_node_t* me_, raft_index_t next_send_idx)
{
    raft_node_private_t* me = (raft_node_private_t*)me_;
    me->next_send_idx = next_send_idx < 1 ? 1 : next_send_idx;
}
