...
/**
 * @return the node's next send index */
raft_index_t raft_node_get_next_send_idx(raft_node_t* node);

/**
 * @return the node's next send index */
void raft_node_set_next_send_idx(raft_node_t* node, raft_index_t next_send_index);
